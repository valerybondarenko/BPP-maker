...
LineTypeTable::LineTypeTable (const LineTypeTable &obj)
:
    Table(obj),
    items(obj.items)
{
...
const LineTypeTable & LineTypeTable::operator = (const LineTypeTable &obj)
{
    if (this != &obj)
    {
        *((Table *)this) = obj;
...
void LineTypeTable::readDXF (Tokenizer &tokenizer)
{
    while (true)
    {
        tokenizer.getToken();
